      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <div className="flex-1 flex flex-col justify-between">
          ...
          <div className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
            <div className="w-full max-w-6xl text-center text-white pt-20 sm:mt-0">
              {/* Text Content */}
          ...
          <div className="pb-6 sm:pb-8 pt-4">
            <div className="flex flex-wrap justify-center gap-3 sm:gap-4 md:gap-6 lg:gap-8 px-2">
              {icons.map(({ icon: Icon, label }, index) => (
                <div
                  key={index}
                  className="group flex flex-col items-center cursor-pointer"
                >
                  <div className="w-10 h-10 xs:w-12 xs:h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 flex items-center justify-center bg-white/95 text-gray-800 rounded-full shadow-lg transition-all duration-300 hover:bg-gray-800 hover:text-white hover:scale-105 hover:shadow-xl">
                    <Icon 
                      size={20} 
                      className="xs:w-5 xs:h-5 sm:w-6 sm:h-6 transition-transform duration-300 group-hover:scale-110" 
                    />
                  </div>
                  <span className="mt-1 xs:mt-2 text-white text-xs xs:text-sm font-medium opacity-90 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap">
                    {label}
                  </span>
                </div>
              ))}
